...
AFKSTR = [
    ...
    "Bu dəqiqə klaviyaturadan uzaqdayam, amma ekranınızda yetərincə yüksək səslə qışqırsanəz, sizi eşidə bilərəm.",
    "Bu yöndə gedirəm\n---->",
    "Bu yöndə qaçıram\n<----",
    ...
    "Sahibim indi məşğuldur. Adınızı, nömrənizi və adresinizi versəniz ona ata bilərəm və beləliklə geri döndüyü zaman.",
