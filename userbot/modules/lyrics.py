...
CmdHelp('lyrics').add_command(
    'lyrics', ' <sənətçinin adı> - <musiqi adı>', 'Musiqi sözlərini gətirir.', 'lyrics System Of a Down - Scince'
).add_command(
    'singer', ' <sənətçinin adı> - <musiqi adı>', 'Musiqi söyləyər.', 'singer System Of a Down - Scince'
).add()
